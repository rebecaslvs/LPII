       ...
       String menu_pp=leitor.next();
        ...
        if("A".equals(menu_pp)==true)
            { 
                ...
                String identificador=(menu_pp)+(numero_a[posicao]+1);
                numero_a[posicao]++;
                    
                System.out.println("Palete adicionado a posição A e ao nível " +numero_a[posicao]);
                ...
                if ("B".equals(menu_pp)==true)
                        {
                            ...
                            String identificador=(menu_pp)+(numero_b[posicao]+1);
                            numero_b[posicao]++;
                            paletes_nivel2.add(identificador);
                           
                            System.out.println("Palete adicionado a posição B e ao nível " +numero_b[posicao]);
                            paletes_nivel2.add(identificador);
    ...
    void menuprincipal()
    {
        ...
        if(menu==1)
        {
            ...
            if(menu==3) //não está funcionando ainda
            {
                ...
                System.out.println(paletes_nivel1.getLast());
            }
    }
}
